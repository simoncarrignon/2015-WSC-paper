...
\begin{table}
	...
	\begin{tabular}{l c c}
		...
		$\mu$ & \raisebox{-.5\height}{\includegraphics[width=5cm]{img/scoreWrtTimeA.png}}&\raisebox{-.5\height}{\includegraphics[width=5cm]{img/scoreWrtTimeB.png}} \\
		$\mu + \alpha$& \raisebox{-.5\height}{\includegraphics[width=5cm]{img/scoreWrtTimeC.png}}&\raisebox{-.5\height}{\includegraphics[width=5cm]{img/scoreWrtTimeD.png}}
