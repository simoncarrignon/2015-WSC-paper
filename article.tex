...
%		\includegraphics[width=6cm]{img/InnovationAndNeutralDistrib.pdf}
		\\
		a) & b) \\
		\end{tabular}

	\end{center}
	\caption{Frequency distribution for: a) the neutral and the trading models. Each points represent the mean for 100 runs b) the neutral model and the composed model.}
	\label{fig:2setDi}
\end{figure}
