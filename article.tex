...
\noindent {\bf SIMON CARRIGNON} is a PhD student at the Pompeu Fabra University. He holds a M.S. in in Cognitive Sciences and a M.A. in History and Philosophy of Science. His work focus on the use of computer modeling and evolutionary method to study Complex Systems. His email address is \email{simon.carrignon@bsc.es}.

\noindent {\bf JEAN-MARC MONTANIER} has obtained his engineering title in the domain of embedded computing. Since then, he has complete a Ph.D. in collective robotics at Universit\'e Paris-Sud XI. The topic of this Ph.D. was focused on the adaptation of a swarm of robots to unknown environments. His latest work in this area has addressed the learning of cooperative strategies, as well as the division of labour. He is now working in a new domain which proposes to apply Agent-Based Models to study economical and cultural evolution. His email address is \email{jeanmarc.montanier@bsc.es}.
