...
%An objective of the research undertaken is to compare these networks between each other and understand their specificities. On top of these comparisons we would also like to determine if these trade networks are comparable to a market economy. 
...
%Jm   -> take care that it is well justified
...
%JM we think that agent stuff is a good tool because blah blah
