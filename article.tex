...
To estimate this the method uses maximum likelihood estimator and Kolmogorof-Smirnov approach. It gives use an estimated $\alpha$ parameter that are summarized in the table~\ref{tab:mualpha}.
