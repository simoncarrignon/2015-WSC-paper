...
The model presented in this work aims to offer a framework for the co-evolution of culture and trades which relies on a low number of parameters. Moreover, to be useful, the framework is developed with the aim to ease the comparison of results obtained when taking cultural or trade into consideration.  This article will focus on the presentation of the framework, its justification and more importantly its validation by reproducing previous results obtained on cultural change, and the ability to produce trade dynamics. The results obtained when studying trade and cultural change are compared with each other.
