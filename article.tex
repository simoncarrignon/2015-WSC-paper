...
%		: loss aversion
%		: reflection effects (reference dependence)
%		: non-linear weightening of probabilities (diminishing sensitivity)
...
%		just transformation of probability, which is actually in EU
%ACE: 
%	tesfatsion: base of ACE -> goal is to simulate complex interactions from large number of agents in decentralised markets. and observe the macroeconomic regularities resulting from that. and feedback look. notably interested in the formation of economic network (extract cites) and the evolution of behavioural norms (extract cites)
...
%Review in Henrich "evolution of cultural evolution";  Lycett 2015
%random copy
%frequency dependent
%influence of political structure

\subsection{Modelisation of Trade and Culture}
%stuff with both in it
%macmillan et l'autre
