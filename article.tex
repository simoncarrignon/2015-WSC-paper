...
% 1. the second aspect is cultural change
% 2. an evolutionary framework has explored this
% 3. a large percentage of cultural products exchanged in an economic basis are neutral
% 4. explain neutrality, model of random copy.
% 5. from this perspective the interest of a product for an individual is directly related to its frequency
% 6. this can potentially affect the product as part of a market because offer/demand is related to frequency
% 7. at the same time, frequency will change depending on trade dynamics.

The second component of our model is focused on the dynamics of cultural change. They comprise the collection of processes that promote or inhibit the spread of information by social interaction within a population \cite[3]{boyd_origin_2005}. This evolutionary framework is being used by an increasing number of social scientists, fostering the development of transdisciplinary efforts designed to understand cultural evolution \cite{henrich_evolution_2003}. Archaeology has a rich tradition of evolutionary studies \cite{lycett_cultural_2015}, exploring concepts such as gene-culture coevolution \cite{burger_absence_2007}, diffusion processes \cite{fort_synthesis_2012}, phylogenetic analysis of material culture \cite{} or detection of rates of change in the archaeological record \cite{premo_cultural_2014}.

Of particular interest to our study are the scenarios where cultural traits are copied by unbiased transmission (i.e. traits which do not have a intrinsic positive or negative value for the individuals adopting them). This situation is often analysed following the genetic theory of neutral evolution \cite{neiman_stylistic_1995}, where the variation of traits is strictly explained by their frequency distribution in the population. There exist a large number of works using this model as the starting point to analyse patterns of cultural change in past societies \cite{lipo_neutralitystyle_2001,shennan_ceramic_2001,steele_ceramic_2010,kandler_nonequilibrium_2013,porcic_exploring_2014,crema_approximate_2014}.
