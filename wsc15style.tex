...
\def\editors2015{L.~Yilmaz, W.~K~V.~Chan, I.~Moon, T.~M.~K.~Roeder, C.~Macal, and M.~Rosetti}
% EDITOR: add new definition above this line



% -------------- settings for the current year ------------------
\def\currentYear {2015}               % EDITOR: update with current year
\def\currentEditors {\editors2015} % EDITOR: update by current editor definition macro
